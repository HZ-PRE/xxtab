...
xcrun swiftc -O -parse-as-library -swift-version 5 -target "$arch-apple-macosx13.0" -framework AppKit -import-objc-header macos/SessionLock.h macos/Xxtab.swift -o "$app/Contents/MacOS/xxtab-macos"
